...
int main()
{
    ...
    // Practice Question 19 ===> Print all numbers form 1 to 10 excepts for 6.
    // for(int i = 1; i <= 10; i++){
    //     if(i == 6){
    //         continue;
    //     }
    ...
    // Practice Question 20 ===> Print all the odd numbers from 5 to 50.
    // for(int i = 5; i <= 50; i++){
    //     if(i % 2 != 0){
    //         printf("%d \n", i);
    //     }
    ...
    // Practice Question 23 ===> calculate the sum of all numbers between 5 and 50. (including 5 & 50)
    int sum = 0;
    for(int i = 5; i <= 50; i++){
        sum += i;
    }
